#import "data.typ" : totalTransactions, highestMonth, lowestMonth, monthlyData, yearlyData, usedRealData
...
#v(1cm)
  ...
  #block(
    ...
    [
      #align(center)[
        #text(style: "italic", fill: rgb("#007700"))[Analysis based on real blockchain transaction data from Kusama network]
      ]
    ]
  )
] else [
  #block(
    ...
    [
      #align(center)[
        #text(style: "italic", fill: rgb("#775500"))[Analysis based on synthetic demonstration data (no GraphQL endpoint available)]
      ]
    ]
  )
]
