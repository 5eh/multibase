...
const musicStyles = [
  { style: "Speedcore", bpmRange: "300+ BPM", description: "Ultra-fast and chaotic electronic music" },
  { style: "Rock", bpmRange: "100-140 BPM", description: "Generally faster than Pop, especially in Punk and Metal variations" },
  { style: "Hip-Hop", bpmRange: "80-120 BPM", description: "Can be slow and groovy or mid-tempo, but rarely very fast" },
  { style: "Reggae", bpmRange: "60-90 BPM", description: "Relaxed groove with emphasis on offbeat rhythms" },
  { style: "Drone Ambient", bpmRange: "20-40 BPM", description: "Extremely slow, focusing on atmosphere over rhythm" }
];
